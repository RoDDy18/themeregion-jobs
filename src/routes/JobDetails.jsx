...
const JobDetails = ()=>{
    return (
        <div>
            ...
            <span><span><a href="#" className="title">Human Resource Manager</a></span> @ <a href="#"> Dropbox Inc</a></span>
            ...
            <li><i className="fa fa-hourglass-start" aria-hidden="true"></i>Application Deadline : Jan 10, 2017</li>
            </ul>
            </div>
            </div>
            </div>
            ...
            <li><span className="icon"><i className="fa fa-industry" aria-hidden="true"></i></span>Industry: <a href="#">Marketing and Advertising</a></li>
            <li><span className="icon"><i className="fa fa-line-chart" aria-hidden="true"></i></span>Experience: <a href="#">Entry level</a></li>
            <li><span className="icon"><i className="fa fa-key" aria-hidden="true"></i></span>Job function: Advertising,Design, Art/Creative</li>
            </ul>
            </div>
            ...
            <li>Email: <a href="#"><span className="__cf_email__" data-cfemail="462f282029062234293624293e6825292b">[email&#160;protected]</span></a></li>
